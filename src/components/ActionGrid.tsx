        ...
        <div className="relative mt-0.5 mb-1">
          ...
          <div className={`w-full bg-white rounded-xl border-2 ${activeTourStep === 'socials' ? 'border-[#5D9CFF] shadow-lg' : 'border-slate-100 shadow-sm'} p-2 pt-3 transition-all duration-300`}>
            <div className="grid grid-cols-3 gap-1.5 mb-1.5">
              <a href="tel:01000000000" onClick={() => trackAction('call_mobile')} onTouchStart={() => {}} className="flex flex-row-reverse items-center justify-center gap-1.5 bg-transparent rounded-xl p-2 group/subbtn hover:border-blue-500 active:border-blue-500 hover:bg-blue-500/10 active:bg-blue-500/10 transition-all h-12 bg-white border-2 border-slate-100">
              ...
              <a href="https://wa.me/201000000000" target="_blank" onClick={() => trackAction('whatsapp_click')} onTouchStart={() => {}} className="flex flex-row-reverse items-center justify-center gap-1.5 bg-transparent rounded-xl p-2 group/subbtn hover:border-[#25D366] active:border-[#25D366] hover:bg-[#25D366]/10 active:bg-[#25D366]/10 transition-all h-12 bg-white border-2 border-slate-100">
              ...
              <a href="tel:0220000000" onClick={() => trackAction('call_landline')} onTouchStart={() => {}} className="flex flex-row-reverse items-center justify-center gap-1.5 bg-transparent rounded-xl p-2 group/subbtn hover:border-slate-400 active:border-slate-400 hover:bg-slate-500/10 active:bg-slate-500/10 transition-all h-12 bg-white border-2 border-slate-100">
            ...
            <div className="grid grid-cols-4 gap-1.5">
              <a href="https://facebook.com" target="_blank" onClick={() => trackAction('facebook_click')} onTouchStart={() => {}} className="flex flex-col items-center justify-center gap-1 bg-transparent rounded-xl p-1 group/btn hover:border-[#1877F2] active:border-[#1877F2] hover:bg-[#1877F2]/10 active:bg-[#1877F2]/10 transition-all h-[58px] bg-white border-2 border-slate-100">
              ...
              <a href="https://instagram.com" target="_blank" onClick={() => trackAction('instagram_click')} onTouchStart={() => {}} className="flex flex-col items-center justify-center gap-1 bg-transparent rounded-xl p-1 group/btn hover:border-[#cc2366] active:border-[#cc2366] hover:bg-[#cc2366]/10 active:bg-[#cc2366]/10 transition-all h-[58px] bg-white border-2 border-slate-100">
